...
const routes=['/','/renovations/','/renovations/whole-home/','/renovations/kitchens-bathrooms/','/renovations/investment-properties/','/experience/','/about/','/start-your-project/','/privacy/'];
export function GET(){
